...
def extract_with_llm(query: str, formatted_results: str) -> Tuple[str, str]:
    ...
    try:
        ...
        prompt = f"""Ты эксперт по поиску информации в документах.
...
5. Если параметр не найден, укажи: "{query}: информация не найдена".
...
Ответь одной строкой в указанном формате."""
        ...
        response = requests.post(
            ...
            json={
                ...
                "max_tokens": 3000  # Ограничиваем длину ответа
            },
            timeout=1200
        )
